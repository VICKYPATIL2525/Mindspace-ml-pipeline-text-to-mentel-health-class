...
> **Visual diagrams** of every flow (end-to-end pipeline, anti-leakage, feature selection, model tuning, outlier handling, hardware utilization, saved artifacts) are in [`PIPELINE_FLOW.md`](PIPELINE_FLOW.md)
